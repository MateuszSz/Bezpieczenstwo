...
<head>
    ...
    <title>Usuń rolę użytkownikowi</title>
...
<h2 class="form-signin-heading">Proszę wybrać użytkownika i rolę do usunięcia</h2>
<form class="form-signin" action="<c:url value="/index/usuwanieRoliUzytkownikowi"/>" method="POST">
